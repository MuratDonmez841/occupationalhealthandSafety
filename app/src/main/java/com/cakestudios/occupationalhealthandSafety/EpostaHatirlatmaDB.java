...
//girilen mail ve şifreyi tutuyor
public class EpostaHatirlatmaDB extends SQLiteOpenHelper {
    private static final String DataBase_Name = "DBhatirlatma";
    ...
    public EpostaHatirlatmaDB(Context context) {
    ...
    public void hatirlatma(String email, String password, String checkboxdurum, String oturumdurum) {
    ...
    public ArrayList<HashMap<String, String>> hatirlatmaList() {
